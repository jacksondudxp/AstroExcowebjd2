            ...
            <tr key={member.id} className="border-b border-slate-200 hover:bg-slate-50">
              ...
              {canEdit && (
                <td className="p-3 text-right">
                  ...
                  <button onClick={() => onDeleteMember(section.id, member.id)} className="text-red-500 hover:text-red-400 px-2 py-1 rounded ml-2">Delete</button>
                </td>
              )}
            </tr>
          ))}
      ...
      <Modal isOpen={isSectionModalOpen} onClose={() => setIsSectionModalOpen(false)} title="Add New Committee Section">
        <form onSubmit={handleAddSection} className="space-y-4">
            ...
            <div className="flex justify-end gap-3 pt-2">
              <button type="button" onClick={() => setIsSectionModalOpen(false)} className="bg-slate-200 hover:bg-slate-300 text-brand-text font-bold py-2 px-4 rounded-lg">Cancel</button>
